            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav" >
                <li class="nav-item active">
                  <a class="nav-link "style="color: #fff" href="{{ url('homepatient') }}">Home <span class="sr-only"></span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" style="color: #fff" href="{{ url('about') }}"> About</a>
                </li>

                <li class="nav-item">
                  <a class="nav-link" style="color: #fff"href="{{  url('contact')}}">Contact Us</a>
                </li>
                @guest
                @if (Route::has('login'))
                    <li class="nav-item">
