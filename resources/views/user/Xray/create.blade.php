...
{{ session( 'failure' ) }}
        ...
        <form action="{{ route('xray.store') }}" method="POST">
            ...
            <div class="formbold-mb-5">
                ...
                <input type="text" name="name" id="name"  class="formbold-form-input" value=" {{ Auth::user()->name }}" />


            <div class="formbold-mb-5">
                <label for="name" class="formbold-form-label"> Phone </label>

                <input type="text" name="phone" id="name"  class="formbold-form-input" />
